    ...
    <div className="bg-background text-foreground">
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 md:py-16">
            ...
            {institutes.map((institute) => (
                ...
                >
                  ...
                  <div className="p-4 md:p-6 flex-grow flex flex-col text-center items-center">
                    <h3 className="text-xl md:text-2xl font-headline font-bold text-primary mb-2">{ambassador.name}</h3>
                    <div className="flex space-x-4 mb-4">
                     ...
                     <div className="flex items-center gap-2 mt-auto pt-4 border-t border-primary/10 w-full justify-center">
                        <Image src={institute.logo} alt={`${institute.name} logo`} width={20} height={20} className="rounded-sm" />
                        <a href={institute.website} target="_blank" rel="noopener noreferrer" className="text-xs md:text-sm text-muted-foreground hover:underline">
                            {institute.name}
                        </a>
                    </div>
                  </div>
        ...
        <div className="mt-16 text-center">
            <Button asChild size="lg" className="bg-accent hover:bg-accent/90 text-accent-foreground font-bold rounded-full text-lg px-8 md:px-10 py-6 md:py-7 shadow-xl transition-transform hover:scale-105">
