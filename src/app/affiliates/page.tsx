      ...
      <div className="bg-primary/5 py-20">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <p className="mt-4 max-w-3xl mx-auto text-lg text-muted-foreground">
            We invite Wikimedia affiliates across India to partner with us in promoting this campaign, organizing local outreach, and helping bring impactful scientific contributions from their regions.
          </p>
        </div>
      </div>
        ...
        <div className="grid md:grid-cols-3 gap-12">
          <div className="md:col-span-2">
            ...
            <p className="text-lg text-muted-foreground mb-8">
              This is a unique opportunity to celebrate science and enrich Wikimedia Commons with freely licensed media. As a partner, your group can play a pivotal role in making India's first national Wiki Science Competition a success.
            </p>
