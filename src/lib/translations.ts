        ...
        competition: {
            ...
            categories: {
                "people": {
                    ...
                    "description": "Scientists, researchers, and individuals engaged in scientific work."
                },
                "microscopy": {
                ...
                "astronomy": {
                    "name": "Astronomy",
                    "description": "Images of stars, planets, celestial events, and astronomical equipment."
                },
                "special": {
                    "name": "Special Category",
                    "description": "Unique and exceptional scientific content that does not fit other categories."
                },
                "everyday": {
                    "name": "Science in Everyday Life",
                    "description": "Images showcasing science in daily life, practical applications, and experiments."
                },
                "equipment": {
                    "name": "Equipment in Science",
                    "description": "Scientific instruments, laboratory setups, and experimental tools."
                },
                "chemistry": {
                    "name": "Science in Chemistry",
                    "description": "Chemical reactions, laboratory chemistry, and molecular science."
                },
                "physics": {
                    "name": "Science in Physics",
                    "description": "Physical experiments, demonstrations, and concepts in physics."
                },
                "mobile": {
                    "name": "Mobile Category",
                    "description": "For students and contributors using mobile devices; captures of science and nature accessible without high-end equipment."
                }
            },
