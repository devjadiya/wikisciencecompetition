...
export const translations = {
  ...
  hi: {
    ...
    footerCopyright: 'विकि विज्ञान प्रतियोगिता भारत। सर्वाधिकार सुरक्षित।',
    footerLicense: 'सामग्री CC BY-SA 4.0 के तहत उपलब्ध है जब तक कि अन्यथा उल्लेख न किया गया हो।',
     about: {
        ...
        p1: 'पहली बार, भारत विकी विज्ञान प्रतियोगिता (WSC) का एक राष्ट्रीय संस्करण आयोजित कर रहा है - जो दुनिया की सबसे बड़ी पहलों में سے एक ہے جو विज्ञान, फोटोग्राफी, और मुफ्त ज्ञान को एक साथ लाती है।',
        p2: '2011 में एस्टोनिया में शुरू हुई और बाद में पूरे यूरोप और दुनिया भर में विस्तारित हुई, इस प्रतियोगिता نے ہزاروں वैज्ञानिकों, शोधकर्ताओं, और उत्साही लोगों को विज्ञान کے عجائب کو कैद करने वाली छवियों को साझा करने के लिए प्रेरित किया है। सूक्ष्म कोशिकाओं से लेकर ब्रह्मांडीय आकाशगंगाओं तक, ये स्वतंत्र रूप سے لائسنس یافتہ योगदान विकिमीडिया कॉमन्स को समृद्ध करते हैं और विश्व स्तर पर खुली शिक्षा का समर्थन करते हैं।',
        ...
        p4: 'विकी विज्ञान प्रतियोगिता 2025 - भारत एक प्रतियोगिता سے زیادہ ہے۔ यह शक्तिशाली छवियों, कहानियों, और रचनात्मकता के माध्यम से भारतीय विज्ञान को दुनिया के सामने प्रस्तुत करने का एक सामूहिक प्रयास है।',
        aims: {
            title: 'हमारे उद्देश्य',
            subtitle: 'इस अभियान के माध्यम से, हमारा लक्ष्य है:',
            items: [
                { icon: 'PenSquare', title: 'योगदान को प्रोत्साहित करें', description: 'पूरे भारत में छात्रों, शोधकर्ताओं और उत्साही लोगों को মূল্যবান वैज्ञानिक मीडिया का योगदान करने کے لیے प्रोत्साहित करें।' },
